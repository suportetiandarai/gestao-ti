            ...
            tbody.innerHTML = data.length > 0 ? data.map(o => {
                ...
                let botoesAcao = `
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2px;">
                        <button class="btn-primary btn-sm" style="background: #3498db; margin: 0; padding: 8px 2px; font-size: 14px;" onclick="abrirModalVerOcorrencia('${o.id}')">👁️ Ver</button>
                        <button class="btn-primary btn-sm" style="background: #f39c12; margin: 0; padding: 8px 2px; font-size: 14px;" onclick="abrirModalEditarOcorrencia('${o.id}')">✏️ Editar</button>
                        <button class="btn-success btn-sm" style="margin: 0; padding: 8px 2px; font-size: 14px;" onclick="abrirModalFinalizarOcorrencia('${o.id}')">✔️ Solucionar</button>
                        <button class="btn-danger btn-sm" style="margin: 0; padding: 8px 2px; font-size: 14px;" onclick="cancelarOcorrencia('${o.id}')">❌ Cancelar</button>
                    </div>
                `;
